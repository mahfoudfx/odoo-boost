...
class TestMigration(TransactionCase):
    ...
    def test_field_migration(self):
        ...
        self.assertEqual(self.test_record.new_field, "value", "Field value should be migrated")
    ...
    def test_state_migration(self):
        ...
        self.assertEqual(self.test_record.state, "new", "State 'draft' should map to 'new'")
```
